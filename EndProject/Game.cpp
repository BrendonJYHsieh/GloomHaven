...
void players_round_UI(vector<Character>& play_Character, Character& Character, vector<Ethnicity>& Monster, Map& Game_Map, int printPoint, vector<string>& game_Massage_string) //角色回合 - 已防呆
{
	...
	if (Character.Rest == false)
	{
		...
		{
			SetColor(7);
			setPrintPosition(i * 6, printPoint + 2);	cout << "╔═══╗";
			...
			setPrintPosition(i * 6, printPoint + 8);	cout << "╚═══╝";
		}
		...
		while (chooseComplete == false) 
		{
			...
			else if (now_card != 2 && (now_card != card || now_movement != movement))
			{
				...
				if (movement == 0) 
				{
					setPrintPosition(card * 6, printPoint + 2);	cout << "╔═══╗";
				...
				else 
				{
					...
					setPrintPosition(card * 6, printPoint + 8);	cout << "╚═══╝";
				}
				SetColor(14);
				if (now_movement == 0)
				{
				...
				else
				{
					...
					setPrintPosition(now_card * 6, printPoint + 8);	cout << "╚═══╝";
				}
				setPrintPosition(0, printPoint + 10);
				SetColor(7);
				cout << "                                                                                                                         " << endl;
	...
	else
	{
		...
		for (int i = 0; i < can_throw_Card.size(); i++)
		{
			...
			setPrintPosition(i * 5, printPoint + 6);	cout << "╚══╝";
		}
		...
		while (checkComplete == false)
		{
			if (nowCard != card)
			{
				...
				setPrintPosition(card * 5, printPoint + 6);	cout << "╚══╝";
				SetColor(14);
				setPrintPosition(nowCard * 5, printPoint + 4);	cout << "╔══╗";
				setPrintPosition(nowCard * 5, printPoint + 5);	cout << "║" << setw(2) << can_throw_Card[nowCard] << "║";
				setPrintPosition(nowCard * 5, printPoint + 6);	cout << "╚══╝";
